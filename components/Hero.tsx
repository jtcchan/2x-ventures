...
export default function Hero() {
  return (
    <section 
      className="relative min-h-[400px] lg:min-h-[660px] lg:h-screen flex flex-col justify-center overflow-hidden px-5 sm:px-6 lg:px-8 pt-[80px] pb-[80px] text-white" 
      style={{ 
