    ...
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 py-[80px] text-white" style={{ background: 'linear-gradient(165deg, #6BC5D2 0%, #5BBFBA 25%, #4A9DAF 50%, #4A90A4 75%, #3D7A94 100%)' }}>
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0">
        ...
        >
          {/* Back layer - subtle */}
          <path
            d="M0 180 L120 160 L240 175 L400 145 L540 165 L680 140 L820 155 L960 125 L1100 135 L1240 110 L1440 120 L1440 280 L0 280 Z"
            fill="rgba(255,255,255,0.12)"
          />
          {/* Middle layer */}
          <path
            d="M0 210 L150 185 L290 205 L450 175 L590 195 L750 165 L910 185 L1070 155 L1210 165 L1440 145 L1440 280 L0 280 Z"
            fill="rgba(255,255,255,0.08)"
          />
          {/* Front layer - white */}
          <path
            d="M0 240 L170 210 L310 235 L510 200 L690 225 L890 190 L1090 215 L1270 195 L1440 160 L1440 280 L0 280 Z"
            fill="#FFFFFF"
          />
          {/* Data points */}
