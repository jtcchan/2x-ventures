...
export default function InvestmentFocus() {
  return (
    <section className="pt-0 pb-[60px] bg-white">
      <div className="max-w-[940px] mx-auto px-[30px] sm:px-[50px] pt-[60px] pb-[60px]">
        ...
        <div className="max-w-[700px] mx-auto text-left">
          <p className="text-base text-gray-500/60 leading-[28px] mb-5">
          ...
          <p className="text-base text-gray-500/60 leading-[28px]">
